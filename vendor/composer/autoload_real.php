...
class ComposerAutoloaderInit7fb36f7a41c5da8166c87d710d968307
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit7fb36f7a41c5da8166c87d710d968307::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire7fb36f7a41c5da8166c87d710d968307($fileIdentifier, $file);
        }
...
function composerRequire7fb36f7a41c5da8166c87d710d968307($fileIdentifier, $file)
{
