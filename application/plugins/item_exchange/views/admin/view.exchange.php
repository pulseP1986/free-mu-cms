        ...
        <div class="box span12">
            <div class="tab-content">          
				<div class="box-header well">
					<h2><i class="icon-edit"></i>Add Exchange</h2>
				</div>
				<div class="box-content">
						<form class="form-horizontal" method="POST" action="" id="add_exchange">	
							<div class="control-group">
								<label class="control-label" for="currency_amount">Reward Amount </label>
								<div class="controls">
									<input type="text" class="span3 typeahead" id="currency_amount" name="currency_amount" value="<?php if(isset($_POST['currency_amount'])){ echo $_POST['currency_amount']; } else { echo 0; }  ?>" required />
							...
							<div class="form-actions">
								<button type="submit" class="btn btn-primary" name="add_exchange" id="add_exchange">Submt</button>
							</div>
						</form>
						<script>
