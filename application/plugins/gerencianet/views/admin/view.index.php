	...
	<div class="row-fluid">
        <div class="span12">
            <ul class="nav nav-pills">
				...
				<li><a href="<?php echo $this->config->base_url;?>gerencianet/logs" role="tab">Logs</a></li> 
			</ul>
                        ...
                        <form class="form-horizontal" method="POST" action="" id="settings_form_<?php echo $key;?>">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <p class="help-block">Use gerencianet module.</p>
                                </div>
                            </div>
							<div class="control-group">
								<label class="control-label" for="client_id">Client Id </label>
								<div class="controls">
									<input type="text" class="span6 typeahead" id="client_id" name="client_id" value="<?php echo $val['client_id']; ?>"/>
									<p class="help-block">Your client id in gerencianet payment system.</p>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="client_secret">Client Secret </label>
								<div class="controls">
									<input type="text" class="span6 typeahead" id="client_secret" name="client_secret" value="<?php echo $val['client_secret']; ?>"/>
									<p class="help-block">Your secret key in gerencianet payment system</p>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="pix_key">Pix Key </label>
								<div class="controls">
									<input type="text" class="span6 typeahead" id="pix_key" name="pix_key" value="<?php echo $val['pix_key']; ?>"/>
									<p class="help-block">Your pix key in gerencianet payment system</p>
								</div>
							</div>
							<div class="control-group">
                                <label class="control-label" for="sandbox">Sandbox </label>
                                <div class="controls">
                                    <select id="sandbox" name="sandbox" required>
                                        <option value="0" <?php if($val['sandbox'] == 0){echo 'selected="selected"';}?>>No</option>
                                        <option value="1" <?php if($val['sandbox'] == 1){echo 'selected="selected"';}?>>Yes</option>
                                    </select>
                                    <p class="help-block">Production or test mode.</p>
                                </div>
                            </div>
							<div class="control-group">
                                <label class="control-label" for="mtls">mTLS </label>
                                <div class="controls">
                                    <select id="mtls" name="mtls" required>
                                        <option value="0" <?php if($val['mtls'] == 0){echo 'selected="selected"';}?>>No</option>
                                        <option value="1" <?php if($val['mtls'] == 1){echo 'selected="selected"';}?>>Yes</option>
                                    </select>
                                    <p class="help-block">If have problems with checkout try change this value.</p>
                                </div>
                            </div>
							<div class="control-group">
							...
							<div class="control-group">
								...
								<div class="controls" style="padding-top: 5px;font-size: 16px;">
									Convert your p12 certificate with <a href="https://pix.gerencianet.com.br/ferramentas/conversorGerencianet.exe">this</a> tool
									and update content of <br /><?php echo APP_PATH.DS.'plugins'.DS.'gerencianet'.DS.'libraries'.DS.'certificate.pem';?> <br />with your certificate data
								</div>
							</div>
