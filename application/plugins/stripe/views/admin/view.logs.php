...
<div id="content" class="span10">
    <div>
        <ul class="breadcrumb">
            <li><a href="<?php echo $this->config->base_url; ?>stripe/admin">Stripe Settings</a> <span class="divider">/</span></li>
            <li><a href="<?php echo $this->config->base_url; ?>stripe/logs">Stripe Transactions</a>
            </li>
        </ul>
    </div>
    <?php
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="input-append">
                                ...
                                <button class="btn" type="submit" name="search_stripe_transactions" value="1">Search</button>
                            </div>
                        </div>
                    </div>
                </form>
