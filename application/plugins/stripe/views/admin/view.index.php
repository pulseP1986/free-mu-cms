...
<div id="content" class="span10">
	...
	<div class="row-fluid">
        <div class="span12">
            <ul class="nav nav-pills">
				...
				<li><a href="<?php echo $this->config->base_url;?>stripe/logs" role="tab">Logs</a></li> 
			</ul>
	...
	$(document).ready(function(){
		$('form[id^="stripe_settings_form_"]').on("submit", function (e){
			e.preventDefault();
			stripe.saveSettings($(this));
		});
		$("#donate_sortable_stripe").find("tbody#donate_sortable_content").sortable({
			placeholder: 'ui-state-highlight',
			opacity: 0.6,
			cursor: 'move',
			update: function() { stripe.saveOrder(); }
		});
	});
	</script>
	<?php endif;?>
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane fade in <?php if($i == 1){?>active<?php }?>" id="<?php echo $key;?>">
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" method="POST" action="" id="stripe_settings_form_<?php echo $key;?>">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <p class="help-block">Use Stripe module.</p>
                                </div>
                            </div>
							<div class="control-group">
								<label class="control-label" for="api_key">Public Key </label>
								<div class="controls">
									<input type="text" class="span6 typeahead" id="api_key" name="api_key" value="<?php echo $val['api_key']; ?>"/>
									<p class="help-block">Your developer public key.</p>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="secret_key">Secret Key </label>
								<div class="controls">
									<input type="text" class="span6 typeahead" id="secret_key" name="secret_key" value="<?php echo $val['secret_key']; ?>"/>
									<p class="help-block">Your developer secret key.</p>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="webhooks_key">Signing secret </label>
								<div class="controls">
									<input type="text" class="span6 typeahead" id="webhooks_key" name="webhooks_key" value="<?php echo $val['webhooks_key']; ?>"/>
									<p class="help-block">Your developer webhooks signing secret.</p>
								</div>
							</div>
							<div class="control-group">
							...
							<div class="control-group">
								<label class="control-label" for="signature">Webhooks Url </label>
								<div class="controls">
									<span style="color:red;"><?php echo $this->config->base_url;?>stripe/payment</span>
									<p class="help-block">Create webhooks in https://dashboard.stripe.com/webhooks set this as endpoint url and select event checkout.session.completed</p>
								</div>
							</div>
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" name="edit_stripe_settings" id="edit_stripe_settings">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
				...
				<div role="tabpanel" class="tab-pane fade in" id="packages">
                    <div class="box-header well">
                        <h2><i class="icon-edit"></i> Stripe Packages</h2>
                    </div>
                    <div class="box-content">
                        <div id="donate_package_list">
                            <table class="table table-striped table-bordered bootstrap-datatable datatable" id="donate_sortable_stripe">
                                <thead>
                                <tr>
                                    <th>Title</th>
                                    <th>Price</th>
                                ...
                                <?php foreach ($packages_stripe as $pack): ?>
                                    <tr id="<?php echo $pack['id']; ?>">
                                        ...
                                        <td class="center">
                                            <?php if ($pack['status'] == 1): ?>
                                                <a class="btn btn-danger" href="#" id="status_button_<?php echo $pack['id']; ?>" onclick="stripe.changeStatus(<?php echo $pack['id']; ?>, 0);">
                                                    <i class="icon-edit icon-white"></i> Disable
                                                </a>
                                            <?php else: ?>
                                                <a class="btn btn-success" href="#" id="status_button_<?php echo $pack['id']; ?>" onclick="stripe.changeStatus(<?php echo $pack['id']; ?>, 1);">
                                                    <i class="icon-edit icon-white"></i> Enable
                                                </a>
                                            <?php endif; ?>
                                            <a class="btn btn-info" href="#" onclick="stripe.edit(<?php echo $pack['id']; ?>);">
                                                <i class="icon-edit icon-white"></i> Edit
                                            </a>
                                            <a class="btn btn-danger" href="#" onclick="stripe.delete(<?php echo $pack['id']; ?>);">
                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                            ...
                            <td class="center">
								...
								<td>
									<a class="btn btn-success" href="#" onclick="stripe.addPackage();">
