					...
					<tr>
						<td style="text-align: center;">
							<div class="form"><form method="post" action="">
								<?php if($character_info['char_password'] != null && $character_info['char_password'] !=''){ ?>
								<input type="text" name="password" id="password" value="" placeholder="<?php echo __('Char Password');?>" /><br />
								<?php } ?>
								<button type="submit" class="button-style2" value="buy_character" name="buy_character"><?php echo __('Buy Now'); ?></button>
							</form></div>
						</td>
					</tr>
				</table>
