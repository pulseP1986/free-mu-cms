				...
				<div class="box-content">
						<form class="form-horizontal" method="POST" action="" id="add_reward">
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span3 typeahead" id="growth_points" name="growth_points" value="<?php if(isset($achData['growth_points'])){ echo $achData['growth_points']; } else { echo 0; }  ?>" required />
							...
							<div class="control-group">
								...
								<div class="controls">
									<select id="decrease_points" name="decrease_points">
										<option value="0" <?php if(isset($achData['decrease_points']) && $achData['decrease_points'] == 0){ echo 'selected="selected"'; } ?>>No</option>
										<option value="1" <?php if(isset($achData['decrease_points']) && $achData['decrease_points'] == 1){ echo 'selected="selected"'; } ?>>Yes</option>
									</select>
								</div>
							</div>
							<div class="control-group">
