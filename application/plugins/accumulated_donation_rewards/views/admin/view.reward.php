				...
				<div class="box-content">
						<form class="form-horizontal" method="POST" action="" id="add_reward">	
							<div class="control-group">
								<label class="control-label" for="growth_points">Growth Points Required </label>
								<div class="controls">
									<input type="text" class="span3 typeahead" id="growth_points" name="growth_points" value="<?php if(isset($_POST['growth_points'])){ echo $_POST['growth_points']; } else { echo 0; }  ?>" required />
									<p class="help-block">Minimum growth points required for getting reward.</p>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="decrease_points">Decrease Growth Points</label>
								<div class="controls">
									<select id="decrease_points" name="decrease_points">
										<option value="0" <?php if(isset($_POST['decrease_points']) && $_POST['decrease_points'] == 0){ echo 'selected="selected"'; } ?>>No</option>
										<option value="1" <?php if(isset($_POST['decrease_points']) && $_POST['decrease_points'] == 1){ echo 'selected="selected"'; } ?>>Yes</option>
									</select>
								</div>
							</div>
							<div class="control-group">
					...
					<tbody>
					 <?php
						if(!empty($reward_list[$server])){
							arsort($reward_list[$server]);
							foreach($reward_list[$server] AS $id => $settings){
								?>
								<tr>          
									<td><?php echo $id;?></td>
									<td><?php echo $settings['growth_points'];?></td>
									<td>
