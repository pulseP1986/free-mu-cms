                                ...
                                <?php
                                    if(isset($error)){
										...
										<li>
											...
											<button class="right custom_button" id="buy_nganluong_' . $packages['id'] . '" style="margin-top: 8px;" value="buy_nganluong_' . $packages['id'] . '">' . __('Buy Now') . '</button>
										</li>
								</ul>';
                                            }
                                        } else{
                                            echo '<div class="i_note">' . __('No nganLuong Packages Found.') . '</div>';
                                        }
                                    }
                                ?>
                            </div>
