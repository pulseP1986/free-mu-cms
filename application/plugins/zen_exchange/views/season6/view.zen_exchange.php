                                    ...
                                    if(isset($config_not_found)):
                                        ...
                                        ?>
                                            <div class="i_note"><?php echo __('Exchange info'); ?>:
                                                <?php
                                                    echo __('You can get') . ' ' . $cred . ' ' . $this->website->translate_credits($plugin_config['reward_type'], $this->session->userdata(['user' => 'server'])) . ' for ' . $this->website->zen_format($zen) . ' ' . __('Zen');
                                                ?>
                                            </div>
                                            <div class="form">
                                                <form method="post" action="" id="zen_exchange_form">
                                                    <table>
                                                        ...
                                                        <tr>
                                                            <td style="width:150px;"><?php echo __('Amount of Zen'); ?>:
                                                            </td>
                                                            <td><input type="text" id="zen" name="zen" value=""
                                                                       class="text"
                                                                       onblur="zenExchange.calculateCurrency($('#zen').val(), '<?php echo $plugin_config['ratio']; ?>');"
                                                                       onkeyup="zenExchange.calculateCurrency($('#zen').val(), '<?php echo $plugin_config['ratio']; ?>');"/>
                                                            </td>
                                                        </tr>
                                                        <tr>
