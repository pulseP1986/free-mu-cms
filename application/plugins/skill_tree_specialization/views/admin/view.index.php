                        ...
                        <form class="form-horizontal" method="POST" action="" id="stats_specialization_settings_form_<?php echo $key;?>">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <p class="help-block">Use skilltree specialization module.</p>
                                </div>
                            </div>
							<div class="control-group">
								<label class="control-label" for="req_mlevel">SkillTree specialization require master level</label>
								<div class="controls">
									<select id="req_level" name="req_mlevel" required>
										<?php for ($a = 0; $a <= 1000; $a++): ?>
											<option
												value="<?php echo $a; ?>" <?php if ($val['req_mlevel'] == $a) {
							...
							<div class="control-group">
                                <label class="control-label" for="allow_restore_after_class_change">Class Limit </label>
                                <div class="controls">
                                    <select id="allow_restore_after_class_change" name="allow_restore_after_class_change" required>
                                        <option value="0" <?php if($val['active'] == 0){echo 'selected="selected"';}?>>No</option>
                                        <option value="1" <?php if($val['active'] == 1){echo 'selected="selected"';}?>>Yes</option>
                                    </select>
                                    <p class="help-block">Allow restoring specialization after changing class.</p>
                                </div>
                            </div>
