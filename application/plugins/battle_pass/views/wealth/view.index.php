		...
		<div class="dmn-page-content">
			<div class="row">
				<div class="col-12">   
					...
					<link rel="stylesheet" href="<?php echo $this->config->base_url; ?>assets/plugins/css/battle_pass2.css?v9"><style>
					...
					<div style="padding:60px;">
						<div class="container-battlepass">
							<div class="row">
								<div class="col-md-12 col-lg-8 row" style="margin-bottom: 0px;">
									...
									<div class="col-md-9 container-bp-info" style="margin-bottom: 0px;">
										<div class="row">
											...
											<tr>
											<td class="time" style="line-height: 80%;">(Closing date: <?php echo $plugin_config['battle_pass_end_time'];?></td>
											</tr>
											</tbody></table>
											</div>
											<div class="col-md-4 hidden-xs hidden-sm hidden-md" style="padding-right: 20px;">
											<br>
											<a href="<?php echo $this->config->base_url;?>account-panel" class="blogin-button"><?php if(!$is_logged_in){ echo __('Login'); } else { echo $this->session->userdata(['user' => 'username']); } ?></a>
											<br><br><br><br>
								...
								<div class="col-md-12 col-lg-4" style="padding-top: 20px; margin-bottom: 0px;">
									<a class="battlepass-button <?php if(in_array($pass['pass_type'], [2]) || !$is_logged_in){ ?>disabled<?php } ?>" <?php if(!in_array($pass['pass_type'], [2]) && $is_logged_in){ ?>href="<?php echo $this->config->base_url;?>battle-pass/upgrade"<?php } ?>>Upgrade BattlePass</a>
								</div>
							</div>
						</div>
						<div class="row battlepass-rewards" style="padding: 0px; width: calc(100% + 70px); margin-left: -30px;">
						<?php
						...
						?>
							<div class="col-md-1">
								<table class="hidden-xs hidden-sm hidden-md">
									...
									<tbody>
										...
										?>
										<tr>
											<td style="height: 125px;line-height:62.5px;padding:0;">Level <b><?php echo $i;?></b></td>
										</tr> 
										<?php	
											$i++;
										}
											...
											<div class="battlepass-ticket-reward">
												...
												<div class="battlepass-ticket-reward-bot">
													...
													<?php if($rewardStatus['is_completed'] == 0){ ?>
														<span class="blogin-button battlepass-claim required"><?php echo __('Incomplete');?></span>
													<?php } else { ?>
														<?php if($rewardStatus['is_free_reward_taken'] == 0){ ?>
															<span class="blogin-button battlepass-claim required"><a class="get_reward" href="javascript:;" id="reward_free_<?php echo $i; ?>" data-action="<?php echo  $this->config->base_url.'battle-pass/claim/'.$dayData['id']; ?>/0"><?php echo __('Claim reward');?></a></span>
														<?php } else { ?>
							...
							<div class="col-lg-4 col-md-6" style="min-width: 272px!important;">
								<table>
									<thead class="battlepass-ticket-top">
									<tr>
									<td style="padding: 0px; width: 75px;">
												...
												<div class="battlepass-ticket-reward-bot">
													...
													<?php } else { ?>
														<?php if($rewardStatus['is_silver_reward_taken'] == 0){ ?>
															<span class="blogin-button battlepass-claim required"><a class="get_reward" href="javascript:;" id="reward_silver_<?php echo $i; ?>" data-action="<?php echo  $this->config->base_url.'battle-pass/claim/'.$dayData['id']; ?>/1"><?php echo __('Claim reward');?></a></span>
														<?php } else { ?>
															<span class="battlepass-claim required"><?php echo __('Completed');?></span>
														<?php } ?>
													<?php } ?>
												...
												<div class="battlepass-ticket-reward-bot">
													...
													<?php } else { ?>
														<?php if($rewardStatus['is_platinum_reward_taken'] == 0){ ?>
															<span class="blogin-button battlepass-claim required"><a class="get_reward" href="javascript:;" id="reward_platinum_<?php echo $i; ?>" data-action="<?php echo  $this->config->base_url.'battle-pass/claim/'.$dayData['id']; ?>/2"><?php echo __('Claim reward');?></a></span>
														<?php } else { ?>
															<span class="battlepass-claim required"><?php echo __('Completed');?></span>
														<?php } ?>
													<?php } ?>
