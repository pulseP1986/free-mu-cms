		...
		<div class="dmn-page-content">
			<div class="row">
				<div class="col-12">   
					...
					?>
						<div class="dayName" style="text-align:center;font-weight:bold;display:block;" <?php if($progress['pass_level'] == $dayData['id']){ ?>id="currentDay"<?php } ?>><?php echo __('Day');?> <?php echo $i;?> <?php if($progress['pass_level'] == $dayData['id']){ ?>(<?php echo __('Current');?>)<?php } ?></div>
							...
							<div class="bTitleData">
																...
																if($fRewardData['reward_type'] == 11){
																	...
																	if($fRewardData['reward_type'] == 8 && $fRewardData['vip_type'] != ''){
																		...
																		if(!empty($fRewardData['item_data'])){
																			$fr1 = '<span id="main_ritem_free_'.$i.'_0" data-info="'.$fRewardData['item_data'][0]['hex'].'" data-info2=\''.$fRewardData['item_data'][0]['item_info'].'\'>'.strip_tags($fRewardData['item_data'][0]['name']).'</span>';
																		}
																	}
																}
															}
															...
															if(!in_array($fRewardData['reward_type'], [8,9,10,11])){
																...
																if($fRewardData['reward_type'] == 11){
																	...
																	if($fRewardData['reward_type'] == 8 && $fRewardData['vip_type'] != ''){
																		...
																		if(!empty($fRewardData['item_data'])){
																			$fr2 = '<span id="main_ritem_free_'.$i.'_1" data-info="'.$fRewardData['item_data'][0]['hex'].'" data-info2=\''.$fRewardData['item_data'][0]['item_info'].'\'>'.strip_tags($fRewardData['item_data'][0]['name']).'</span>';
																		}
																	}
																}
															}
								...
								<div class="bAttached">
									...
									<div class="bDetails-<?php echo $i+1;?>" style="<?php if($progress['pass_level'] == $dayData['id']){ ?>display:block;<?php } else { ?>display: none;<?php } ?>">
										<hd><?php echo __('Requirements');?></hd>
										<ul>
											<?php 
														...
														if(!in_array($fRewardData['reward_type'], [8,9,10,11])){
															...
															if($fRewardData['reward_type'] == 11){
																...
																if($fRewardData['reward_type'] == 8 && $fRewardData['vip_type'] != ''){
																	...
																	if(!empty($fRewardData['item_data'])){
																		$afr .= '<li><span id="additional_ritem_free_'.$i.'_'.$b.'" data-info="'.$fRewardData['item_data'][0]['hex'].'"  data-info2=\''.$fRewardData['item_data'][0]['item_info'].'\'>'.strip_tags($fRewardData['item_data'][0]['name']).'</span></li>';
																	}
																}
															}
														}
															...
															if(!in_array($fRewardData['reward_type'], [8,9,10,11])){
																...
																if($fRewardData['reward_type'] == 11){
																	...
																	if($fRewardData['reward_type'] == 8 && $fRewardData['vip_type'] != ''){
																		...
																		if(!empty($fRewardData['item_data'])){
																			$fr1 = '<span id="main_ritem_silver_'.$i.'_0" data-info="'.$fRewardData['item_data'][0]['hex'].'" data-info2=\''.$fRewardData['item_data'][0]['item_info'].'\'>'.strip_tags($fRewardData['item_data'][0]['name']).'</span>';
																		}
																	}
																}
															}
															...
															if(!in_array($fRewardData['reward_type'], [8,9,10,11])){
																...
																if($fRewardData['reward_type'] == 11){
																	...
																	if($fRewardData['reward_type'] == 8 && $fRewardData['vip_type'] != ''){
																		...
																		if(!empty($fRewardData['item_data'])){
																			$fr2 = '<span id="main_ritem_silver_'.$i.'_1" data-info="'.$fRewardData['item_data'][0]['hex'].'" data-info2=\''.$fRewardData['item_data'][0]['item_info'].'\'>'.strip_tags($fRewardData['item_data'][0]['name']).'</span>';
																		}
																	}
																}
															}
														...
														if(!in_array($fRewardData['reward_type'], [8,9,10,11])){
															...
															if($fRewardData['reward_type'] == 11){
																...
																if($fRewardData['reward_type'] == 8 && $fRewardData['vip_type'] != ''){
																	...
																	if(!empty($fRewardData['item_data'])){
																		$afr .= '<li><span id="additional_ritem_silver_'.$i.'_'.$b.'" data-info="'.$fRewardData['item_data'][0]['hex'].'" data-info2=\''.$fRewardData['item_data'][0]['item_info'].'\'>'.strip_tags($fRewardData['item_data'][0]['name']).'</span></li>';
																	}
																}
															}
														}
															...
															if(!in_array($fRewardData['reward_type'], [8,9,10,11])){
																...
																if($fRewardData['reward_type'] == 11){
																	...
																	if($fRewardData['reward_type'] == 8 && $fRewardData['vip_type'] != ''){
																		...
																		if(!empty($fRewardData['item_data'])){
																			$fr1 = '<span id="main_ritem_platinum_'.$i.'_0" data-info="'.$fRewardData['item_data'][0]['hex'].'" data-info2=\''.$fRewardData['item_data'][0]['item_info'].'\'>'.strip_tags($fRewardData['item_data'][0]['name']).'</span>';
																		}
																	}
																}
															}
															...
															if(!in_array($fRewardData['reward_type'], [8,9,10,11])){
																...
																if($fRewardData['reward_type'] == 11){
																	...
																	if($fRewardData['reward_type'] == 8 && $fRewardData['vip_type'] != ''){
																		...
																		if(!empty($fRewardData['item_data'])){
																			$fr2 = '<span id="main_ritem_platinum_'.$i.'_1" data-info="'.$fRewardData['item_data'][0]['hex'].'" data-info2=\''.$fRewardData['item_data'][0]['item_info'].'\'>'.strip_tags($fRewardData['item_data'][0]['name']).'</span>';
																		}
																	}
																}
															}
														...
														if(!in_array($fRewardData['reward_type'], [8,9,10,11])){
															...
															if($fRewardData['reward_type'] == 11){
																...
																if($fRewardData['reward_type'] == 8 && $fRewardData['vip_type'] != ''){
																	...
																	if(!empty($fRewardData['item_data'])){
																		$afr .= '<li><span id="additional_ritem_platinum_'.$i.'_'.$b.'" data-info="'.$fRewardData['item_data'][0]['hex'].'" data-info2=\''.$fRewardData['item_data'][0]['item_info'].'\'>'.strip_tags($fRewardData['item_data'][0]['name']).'</span></li>';
																	}
																}
															}
														}
					...
					$(document).ready(function() {
						...
						$('.collectItem').each(function () {
							App.initializeTooltip($(this), true, 'warehouse/item_info_image');
						});	
						$('span[id^="main_ritem_"], span[id^="additional_ritem_"]').each(function () {
						...
						$('html, body').animate({
							scrollTop: $('#currentDay').offset().top - 50
						}, 'slow');
					});
					</script>
					<?php
