											...
											if(!empty($pass_rewards[$dayData['id']])){
												...
												foreach($pass_rewards[$dayData['id']] AS $fKey => $fRewardData){
													if($fRewardData['pass_type'] == 0){
														if($a == 0){
															if(!in_array($fRewardData['reward_type'], [8,9,10])){
										...
										<div style="text-align:left;">
											...
											<?php } else { ?>
												<?php if($rewardStatus['is_free_reward_taken'] == 0){ ?>
													<a class="get_reward" href="javascript:;" id="reward_free_<?php echo $i; ?>" data-action="<?php echo  $this->config->base_url.'battle-pass/claim/'.$progress['pass_level']; ?>/0"><?php echo __('Claim reward');?></a>
												<?php } else { ?>
										...
										<div style="text-align:left;">
											...
											<?php } else { ?>
												<?php if($rewardStatus['is_silver_reward_taken'] == 0){ ?>
													<a class="get_reward" href="javascript:;" id="reward_silver_<?php echo $i; ?>" data-action="<?php echo  $this->config->base_url.'battle-pass/claim/'.$progress['pass_level']; ?>/1"><?php echo __('Claim reward');?></a>
												<?php } else { ?>
													<?php echo __('Completed');?>
												<?php } ?>
											<?php } ?>
										...
										<div style="text-align:left;">
											...
											<?php } else { ?>
												<?php if($rewardStatus['is_platinum_reward_taken'] == 0){ ?>
													<a class="get_reward" href="javascript:;" id="reward_platinum_<?php echo $i; ?>" data-action="<?php echo  $this->config->base_url.'battle-pass/claim/'.$progress['pass_level']; ?>/2"><?php echo __('Claim reward');?></a>
												<?php } else { ?>
													<?php echo __('Completed');?>
												<?php } ?>
											<?php } ?>
