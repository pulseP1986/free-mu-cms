        ...
        <div class="box span12">
            <div class="tab-content">          
				<div class="box-header well">
					<h2><i class="icon-edit"></i> Create Level</h2>
				</div>
				<div class="box-content">
					...
					<form class="form-horizontal" method="POST" action="" id="create_level">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="span3 typeahead" id="free_pass_image" name="free_pass_image" value="<?php if(isset($_POST['free_pass_image'])){ echo $_POST['free_pass_image']; } ?>" placeholder="http://" />
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="span3 typeahead" id="free_pass_wcoins" name="free_pass_wcoins" value="<?php if(isset($_POST['free_pass_wcoins'])){ echo $_POST['free_pass_wcoins']; } ?>" placeholder="0" />
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="span3 typeahead" id="silver_pass_image" name="silver_pass_image" value="<?php if(isset($_POST['silver_pass_image'])){ echo $_POST['silver_pass_image']; } ?>" placeholder="http://" />
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="span3 typeahead" id="silver_pass_wcoins" name="silver_pass_wcoins" value="<?php if(isset($_POST['silver_pass_wcoins'])){ echo $_POST['silver_pass_wcoins']; } ?>" placeholder="0" />
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="span3 typeahead" id="platinum_pass_image" name="platinum_pass_image" value="<?php if(isset($_POST['platinum_pass_image'])){ echo $_POST['platinum_pass_image']; } ?>" placeholder="http://" />
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="span3 typeahead" id="platinum_pass_wcoins" name="platinum_pass_wcoins" value="<?php if(isset($_POST['platinum_pass_wcoins'])){ echo $_POST['platinum_pass_wcoins']; } ?>" placeholder="0" />
								<p class="help-block">WCoins bonus for platinum level completion</p>
							</div>
						</div>
						<div class="form-actions">
							<button type="submit" class="btn btn-primary" name="add_level" id="add_level">Submit</button>
						</div>
					</form>
				</div>
            </div>
