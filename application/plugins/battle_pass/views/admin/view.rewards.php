        ...
        <div class="box span12">
            <div class="tab-content">          
				<div class="box-header well">
					<h2><i class="icon-edit"></i> Add Rewards</h2>
				</div>
				<div class="box-content">
					...
					?>
					<form class="form-horizontal" method="POST"  action="<?php echo $this->config->base_url;?>battle-pass/rewards/<?php echo $aid;?>/<?php echo $server;?>">
						<div class="control-group">
							<label class="control-label" for="pass_type">Pass Type </label>
							<div class="controls">
								<select class="span3" id="pass_type" name="pass_type" required>
									<option value="0" <?php if(isset($_POST['pass_type']) && $_POST['pass_type'] == 0){ echo 'selected="selected"'; } ?>>Free</option>
									<option value="1" <?php if(isset($_POST['pass_type']) && $_POST['pass_type'] == 1){ echo 'selected="selected"'; } ?>>Silver</option>
									<option value="2" <?php if(isset($_POST['pass_type']) && $_POST['pass_type'] == 2){ echo 'selected="selected"'; } ?>>Platinum</option>
								</select>
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
								<select class="span3" id="reward_type" name="reward_type" required>
									<option value="" <?php if(isset($_POST['reward_type']) && $_POST['reward_type'] == ''){ echo 'selected="selected"'; } ?>>Select</option>
									<option value="1" <?php if(isset($_POST['reward_type']) && $_POST['reward_type'] == 1){ echo 'selected="selected"'; } ?>>Credits 1</option>
									<option value="2" <?php if(isset($_POST['reward_type']) && $_POST['reward_type'] == 2){ echo 'selected="selected"'; } ?>>Credits 2</option>
									<option value="3" <?php if(isset($_POST['reward_type']) && $_POST['reward_type'] == 3){ echo 'selected="selected"'; } ?>>WCoins</option>
									<option value="4" <?php if(isset($_POST['reward_type']) && $_POST['reward_type'] == 4){ echo 'selected="selected"'; } ?>>Goblin Points</option>
									<option value="5" <?php if(isset($_POST['reward_type']) && $_POST['reward_type'] == 5){ echo 'selected="selected"'; } ?>>Zen on Character</option>
									<option value="6" <?php if(isset($_POST['reward_type']) && $_POST['reward_type'] == 6){ echo 'selected="selected"'; } ?>>Zen in WebWallet</option>
									<option value="7" <?php if(isset($_POST['reward_type']) && $_POST['reward_type'] == 7){ echo 'selected="selected"'; } ?>>Ruud</option>
									<option value="8" <?php if(isset($_POST['reward_type']) && $_POST['reward_type'] == 8){ echo 'selected="selected"'; } ?>>Vip Package</option>
									<option value="9" <?php if(isset($_POST['reward_type']) && $_POST['reward_type'] == 9){ echo 'selected="selected"'; } ?>>Item</option>
									<option value="10" <?php if(isset($_POST['reward_type']) && $_POST['reward_type'] == 10){ echo 'selected="selected"'; } ?>>Item hex</option>
									<option value="11" <?php if(isset($_POST['reward_type']) && $_POST['reward_type'] == 11){ echo 'selected="selected"'; } ?>>Buff Item</option>
									<option value="12" <?php if(isset($_POST['reward_type']) && $_POST['reward_type'] == 12){ echo 'selected="selected"'; } ?>>Wheel Spin</option>
								</select>
							</div>
						</div>
							...
							<div class="control-group">
								...
								<div class="controls" id="itemlist">
									...
									<div id="item_<?php echo $i + 1;?>" <?php if($i > 0){?>style="margin-top:2px;"<?php } ?>>
										...
										Luck: <input class="form-control" style="width:40px; display: inline;" type="text" name="item_luck[]" value="<?php echo $_POST['item_luck'][$i];?>" placeholder="0/1" /><br /> 
							...
							<div class="control-group">
								<div class="controls">
									<label class="checkbox inline">
										<input type="checkbox" name="display_item_code" data-no-uniform="true" value="1" <?php if(isset($_POST['display_item_code']) && $_POST['display_item_code'] == 1){ echo 'checked'; } ?>>
						...
						<div id="single_item_hex" style="display:none;">
							...
							<div class="control-group">
								<div class="controls">
									<label class="checkbox inline">
										<input type="checkbox" name="display_item_code_hex" data-no-uniform="true" value="1" <?php if(isset($_POST['display_item_code_hex']) && $_POST['display_item_code_hex'] == 1){ echo 'checked'; } ?>>
										Display reward title instead of items list
									</label>
									<div style="clear:both"></div>
								</div>
						...
						<div class="form-actions">
							<button type="submit" class="btn btn-primary" name="add_reward" id="add_reward">Submit</button>
						</div>
					</form>
					<script>
						$(document).ready(function() {
