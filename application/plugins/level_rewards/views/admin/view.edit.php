				...
				<div class="box-content">
						<form class="form-horizontal" method="POST" action="" id="add_reward">
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span3 typeahead" id="min_level" name="min_level" value="<?php if(isset($achData['min_level'])){ echo $achData['min_level']; } else { echo 0; }  ?>" required />
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span3 typeahead" id="min_mlevel" name="min_mlevel" value="<?php if(isset($achData['min_mlevel'])){ echo $achData['min_mlevel']; } else { echo 0; }  ?>" required />
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span3 typeahead" id="min_resets" name="min_resets" value="<?php if(isset($achData['min_resets'])){ echo $achData['min_resets']; } else { echo 0; }  ?>" required />
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span3 typeahead" id="min_gresets" name="min_gresets" value="<?php if(isset($achData['min_gresets'])){ echo $achData['min_gresets']; } else { echo 0; }  ?>" required />
