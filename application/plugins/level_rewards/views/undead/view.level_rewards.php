				...
				<div class="col-12">   
					...
					<link rel="stylesheet" type="text/css" href="<?php echo $this->config->base_url; ?>assets/plugins/css/level_rewards.css?v2">
							...
							<div id="rewards-list-<?php echo $rid;?>" style="display: none;width: 100%;text-align: center;">
								<table class="table dmn-rankings-table table-striped" style="width: 612px;margin: 0px auto;">
									<thead>
										<tr>
								...
								<div class="d-flex justify-content-center align-items-center mb-1 mt-1">
									<a class="btn btn-primary" href="<?php echo $this->config->base_url;?>level-rewards/claim/<?php echo $rid;?>"><?php echo __('Get Reward');?></a>
								</div>
							</div>
							<?php } ?>	
							<?php } ?>
