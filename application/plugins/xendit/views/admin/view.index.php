...
<div id="content" class="span10">
	...
	<div class="row-fluid">
        <div class="span12">
            <ul class="nav nav-pills">
				...
				<li><a href="<?php echo $this->config->base_url;?>xendit/logs" role="tab">Logs</a></li> 
			</ul>
	...
	var xendit = new xendit();
	xendit.setUrl('<?php echo $this->config->base_url . $this->request->get_controller();?>');
	$(document).ready(function(){
		$('form[id^="settings_form_"]').on("submit", function (e){
			e.preventDefault();
			xendit.saveSettings($(this));
		});
		$("#donate_sortable_xendit").find("tbody#donate_sortable_content").sortable({
			placeholder: 'ui-state-highlight',
			opacity: 0.6,
			cursor: 'move',
			update: function() { xendit.saveOrder(); }
		});
	});
	</script>
	<?php endif;?>
        ...
        <div class="box span12">
            <div class="tab-content">
                        ...
                        <form class="form-horizontal" method="POST" action="" id="settings_form_<?php echo $key;?>">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <p class="help-block">Use Xendit module.</p>
                                </div>
                            </div>
							<div class="control-group">
								<label class="control-label" for="public_key">Public Key </label>
								<div class="controls">
									<input type="text" class="span6 typeahead" id="public_key" name="public_key" value="<?php echo $val['public_key']; ?>"/>
									<p class="help-block">Your api key in xendit payment system.</p>
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									...
									<p class="help-block">Your secret key in xendit payment system</p>
								</div>
							</div>
							<div class="control-group">
				...
				<div role="tabpanel" class="tab-pane fade in" id="packages">
                    <div class="box-header well">
                        <h2><i class="icon-edit"></i> Xendit Packages</h2>
                    </div>
                    <div class="box-content">
                        <div id="donate_package_list">
                            <table class="table table-striped table-bordered bootstrap-datatable datatable" id="donate_sortable_xendit">
                                <thead>
                                <tr>
                                    <th>Title</th>
                                    <th>Price</th>
                                ...
                                <?php foreach ($packages_xendit as $pack): ?>
                                    <tr id="<?php echo $pack['id']; ?>">
                                        ...
                                        <td class="center">
											<select id="pack_currency_<?php echo $pack['id']; ?>" class="input-medium">
												...
												<option value="PHP" <?php if ('PHP' == $pack['currency']){ ?>selected="selected"<?php } ?>>PHP</option>
											</select>
										</td>
                                        ...
                                        <td class="center">
                                            <?php if ($pack['status'] == 1): ?>
                                                <a class="btn btn-danger" href="#" id="status_button_<?php echo $pack['id']; ?>" onclick="xendit.changeStatus(<?php echo $pack['id']; ?>, 0);">
                                                    <i class="icon-edit icon-white"></i> Disable
                                                </a>
                                            <?php else: ?>
                                                <a class="btn btn-success" href="#" id="status_button_<?php echo $pack['id']; ?>" onclick="xendit.changeStatus(<?php echo $pack['id']; ?>, 1);">
                                                    <i class="icon-edit icon-white"></i> Enable
                                                </a>
                                            <?php endif; ?>
                                            <a class="btn btn-info" href="#" onclick="xendit.edit(<?php echo $pack['id']; ?>);">
                                                <i class="icon-edit icon-white"></i> Edit
                                            </a>
                                            <a class="btn btn-danger" href="#" onclick="xendit.delete(<?php echo $pack['id']; ?>);">
                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                            ...
                            <td class="center">
								...
								<td>
									<a class="btn btn-success" href="#" onclick="xendit.addPackage();">
