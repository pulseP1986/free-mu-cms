...
?>
    <div id="content" class="span10">
        <div>
            <ul class="breadcrumb">
                <li><a href="<?php echo $this->config->base_url; ?>merchant/admin">Merchant Settings</a> <span
                            class="divider">/</span></li>
                <li><a href="<?php echo $this->config->base_url; ?>merchant/logs">Merchant Logs</a>
                </li>
            </ul>
        </div>
        <?php
        ...
        <div class="row-fluid">
            <div class="box span12">
                <div class="box-header well">
                    <h2><i class="icon-edit"></i> Search logs by merchant account</h2>
                </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-append">
                                    ...
                                    <button class="btn" type="submit" name="search_merchant_logs" value="1">
                                        Search
                                    </button>
                                </div>
                            </div>
