    ...
    <?php if(isset($js)): ?>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                $('form[id^="credits_transfer_settings_form_"]').on("submit", function (e) {
                    e.preventDefault();
                    transferCurrency.saveSettings($(this));
                });
            });
        </script>
    <?php endif; ?>
                        ...
                        <div role="tabpanel" class="tab-pane fade in <?php if($i == 1){ ?>active<?php } ?>"
                            ...
                            <div class="box-content">
                                <form class="form-horizontal" method="POST" action=""
                                      id="credits_transfer_settings_form_<?php echo $key; ?>">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <p class="help-block">Use credits transfer module.</p>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="min_credits">Min Currency </label>

                                        <div class="controls">
                                            <input type="text" class="span3 typeahead" id="min_credits" name="min_credits"
                                                   value="<?php echo $val['min_credits']; ?>" required/>

                                            <p class="help-block">Min currency in one transfer.</p>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="tax">Server tax </label>

                                        <div class="controls">
                                            <input type="text" class="span3 typeahead" id="tax" name="tax"
                                                   value="<?php echo $val['tax']; ?>" required/>

                                            <p class="help-block">
                                                Server tax for transfer
                                            </p>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="transfer_type">Currency Type</label>

                                        <div class="controls">
                                            <select id="transfer_type" name="transfer_type[]" required multiple>
                                                <option value="1" <?php if (strpos($val['transfer_type'], '1') !== false) {
                                                    echo 'selected="selected"';
                                                } ?>>Credits 1
                                                </option>
                                                <option value="2" <?php if (strpos($val['transfer_type'], '2') !== false) {
                                                    echo 'selected="selected"';
                                                } ?>>Credits 2
                                                </option>
                                            </select>
                                    ...
                                    <div class="form-actions">
                                        <button type="submit" class="btn btn-primary" name="edit_credits_transfer_settings"
                                                id="edit_credits_transfer_settings">Save changes
                                        </button>
                                    </div>
                                </form>
                            </div>
