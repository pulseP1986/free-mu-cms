	...
	<div class="row-fluid">
        <div class="span12">
            <ul class="nav nav-pills">
				...
				<li><a href="<?php echo $this->config->base_url;?>binance/logs" role="tab">Logs</a></li> 
			</ul>
                        ...
                        <form class="form-horizontal" method="POST" action="" id="settings_form_<?php echo $key;?>">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <p class="help-block">Use Binance Pay module.</p>
                                </div>
                            </div>
							<div class="control-group">
								...
								<div class="controls">
									...
									<p class="help-block">Your api key in binance payment system.</p>
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									...
									<p class="help-block">Your secret key in binance payment system</p>
								</div>
							</div>
							<div class="control-group">
							...
							<div class="control-group">
								<label class="control-label">Webhooks Url</label>
								<div class="controls" style="padding-top: 5px;font-size: 16px;">
									<?php echo $this->config->base_url;?>binance/notify
								</div>
							</div>
                                    ...
                                    <tr id="<?php echo $pack['id']; ?>">
                                        ...
                                        <td class="center">
											<select id="pack_currency_<?php echo $pack['id']; ?>" class="input-medium">
												<option value="BUSD" <?php if ('BUSD' == $pack['currency']){ ?>selected="selected"<?php } ?>>BUSD</option>
												<option value="USDT" <?php if ('USDT' == $pack['currency']){ ?>selected="selected"<?php } ?>>USDT</option>
											</select>
										</td>
