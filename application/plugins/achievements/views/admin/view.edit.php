        ...
        <div class="box span12">
            <div class="tab-content">          
				<div class="box-header well">
					<h2><i class="icon-edit"></i> Edit Achievement</h2>
				</div>
				<div class="box-content">
					...
					<form class="form-horizontal" method="POST" action="" id="create_achievement">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="span3 typeahead" id="desc" name="desc" value="<?php if(isset($achData['desc'])){ echo $achData['desc']; } ?>" required />
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="span3 typeahead" id="image" name="image" value="<?php if(isset($achData['image'])){ echo $achData['image']; } ?>" placeholder="http://" />
                                    ...
                                    <?php
                                        ...
                                        foreach($catConfig as $key => $cat){
                                            if(isset($newCats[$key])){
                                                ...
                                                if(!isset($cat['parent_id']) || $cat['parent_id'] == ''){
													$selected = '';
													if(isset($achData['category']) && $achData['category'] == $key){
														$selected = 'selected';
													}
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="span3 typeahead" id="points" name="points" value="<?php if(isset($achData['points'])){ echo $achData['points']; } ?>" required placeholder="10" />
						...
						<div class="control-group">
							...
							<div class="controls">
								<select class="span3" id="period" name="period" required>
									<option value="0" <?php if(isset($achData['period']) && $achData['period'] == 0){ echo 'selected="selected"'; } ?>>Permanent</option>
									<option value="1" <?php if(isset($achData['period']) && $achData['period'] == 1){ echo 'selected="selected"'; } ?>>Daily Reset</option>
									<option value="2" <?php if(isset($achData['period']) && $achData['period'] == 2){ echo 'selected="selected"'; } ?>>Weekly Reset</option>
									<option value="3" <?php if(isset($achData['period']) && $achData['period'] == 3){ echo 'selected="selected"'; } ?>>Monhtly Reset</option>
								</select>
							</div>
						</div>
						<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6" id="min_lvl" name="min_lvl" value="<?php if(isset($achData['min_lvl'])){ echo $achData['min_lvl']; } ?>" placeholder="1" />
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6" id="min_mlvl" name="min_mlvl" value="<?php if(isset($achData['min_mlvl'])){ echo $achData['min_mlvl']; } ?>" placeholder="1" />
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6" id="min_res" name="min_res" value="<?php if(isset($achData['min_res'])){ echo $achData['min_res']; } ?>" placeholder="0" />
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6" id="min_gres" name="min_gres" value="<?php if(isset($achData['min_gres'])){ echo $achData['min_gres']; } ?>" placeholder="0" />
						...
						<div class="control-group">
							...
							<div class="controls">
								<?php
									$class = [];
									if(isset($achData['class']) && $achData['class'] != ''){
										$class = $achData['class'];
									}
								?>
						...
						<div class="control-group">
							...
							<div class="controls">
								<select class="span3" id="achievement_type" name="achievement_type" required>
									<option value="" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == ''){ echo 'selected="selected"'; } ?>>Select</option>
									<option value="0" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 0){ echo 'selected="selected"'; } ?>>Do Nothing</option>
									<option value="1" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 1){ echo 'selected="selected"'; } ?>>Collect Zen</option>
									<option value="2" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 2){ echo 'selected="selected"'; } ?>>Collect Ruud</option>
									<option value="3" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 3){ echo 'selected="selected"'; } ?>>Collect WCoins</option>
									<option value="4" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 4){ echo 'selected="selected"'; } ?>>Collect GoblinPoints</option>
									<option value="5" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 5){ echo 'selected="selected"'; } ?>>Vote</option>
									<option value="6" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 6){ echo 'selected="selected"'; } ?>>Donate</option>
									<option value="7" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 7){ echo 'selected="selected"'; } ?>>Kill Monsters</option>
									<option value="8" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 8){ echo 'selected="selected"'; } ?>>Kill Players</option>
									<option value="9" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 9){ echo 'selected="selected"'; } ?>>Collect Items</option>
									<option value="10" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 10){ echo 'selected="selected"'; } ?>>Level</option>
									<option value="11" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 11){ echo 'selected="selected"'; } ?>>Master Level</option>
									<option value="12" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 12){ echo 'selected="selected"'; } ?>>Reset</option>
									<option value="13" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 13){ echo 'selected="selected"'; } ?>>Grand Reset</option>
									<option value="14" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 14){ echo 'selected="selected"'; } ?>>Refer a friend</option>
									<option value="15" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 15){ echo 'selected="selected"'; } ?>>BloodCastle</option>
									<option value="16" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 16){ echo 'selected="selected"'; } ?>>DevilSquare</option>
									<option value="17" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 17){ echo 'selected="selected"'; } ?>>ChaosCastle</option>
									<option value="18" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 18){ echo 'selected="selected"'; } ?>>IllusionTemple</option>
									<option value="19" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 19){ echo 'selected="selected"'; } ?>>Duels</option>
									<option value="20" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 20){ echo 'selected="selected"'; } ?>>Gens</option>
									<option value="21" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 21){ echo 'selected="selected"'; } ?>>Buy Shop Item</option>
									<option value="22" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 22){ echo 'selected="selected"'; } ?>>Sell Market Item</option>
									<option value="23" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 23){ echo 'selected="selected"'; } ?>>Complete Achievements</option>
									<option value="24" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 24){ echo 'selected="selected"'; } ?>>Maxed Out</option>
									<option value="25" <?php if(isset($achData['achievement_type']) && $achData['achievement_type'] == 25){ echo 'selected="selected"'; } ?>>Online Time</option>
								</select>
							</div>
						</div>
						<div class="control-group" id="amount" style="display:none;">
							...
							<div class="controls">
								<select class="span3" id="decreaset_amount" name="decreaset_amount">									
									<option value="0" <?php if(isset($achData['decreaset_amount']) && $achData['decreaset_amount'] == 0){ echo 'selected="selected"'; } ?>>No</option>
									<option value="1" <?php if(isset($achData['decreaset_amount']) && $achData['decreaset_amount'] == 1){ echo 'selected="selected"'; } ?>>Yes</option>
								</select>
						...
						<div class="control-group" id="maxed" style="display:none;">
							...
							<div class="controls">
								<input type="text" class="span3 typeahead" id="total_level" name="total_level" value="<?php if(isset($achData['total_level'])){ echo $achData['total_level']; } ?>" placeholder="1" />								
							</div>
							<label class="control-label" for="total_mlevel">Req MLevel</label>
							<div class="controls">
								<input type="text" class="span3 typeahead" id="total_mlevel" name="total_mlevel" value="<?php if(isset($achData['total_mlevel'])){ echo $achData['total_mlevel']; } ?>" placeholder="1" />								
							</div>
							<label class="control-label" for="total_res">Req Resets</label>
							<div class="controls">
								<input type="text" class="span3 typeahead" id="total_res" name="total_res" value="<?php if(isset($achData['total_res'])){ echo $achData['total_res']; } ?>" placeholder="1" />								
							</div>
							<label class="control-label" for="total_gres">Req GResets</label>
							<div class="controls">
								<input type="text" class="span3 typeahead" id="total_gres" name="total_gres" value="<?php if(isset($achData['total_gres'])){ echo $achData['total_gres']; } ?>" placeholder="1" />								
							</div>
						</div>
						<div class="control-group" id="referrals" style="display:none;">
							<label class="control-label" for="total_ref">Req Referrals</label>
							<div class="controls">
								<input type="text" class="span3 typeahead" id="total_ref" name="total_ref" value="<?php if(isset($achData['total_ref'])){ echo $achData['total_ref']; } ?>" placeholder="10" />								
							</div>
						</div>
						<div class="control-group" id="gens" style="display:none;">
							<label class="control-label" for="total_contr">Req Contribution</label>
							<div class="controls">
								<input type="text" class="span3 typeahead" id="total_contr" name="total_contr" value="<?php if(isset($achData['total_contr'])){ echo $achData['total_contr']; } ?>" placeholder="1000" />								
							</div>
						</div>
						...
						<div class="control-group" id="events1" style="display:none;">
							...
							<div class="controls">
								<input type="text" class="span3 typeahead" id="total_score" name="total_score" value="<?php if(isset($achData['total_score'])){ echo $achData['total_score']; } ?>" placeholder="1000" />
						...
						<div class="control-group" id="events2" style="display:none;">
							...
							<div class="controls">
								<input type="text" class="span3 typeahead" id="total_wins" name="total_wins" value="<?php if(isset($achData['total_wins'])){ echo $achData['total_wins']; } ?>" placeholder="100" />
						...
						<div class="control-group" id="items3" style="display:none;">
							...
							<div class="controls" id="itemlist">
								...
								<div id="item_<?php echo $i + 1;?>" <?php if($i > 0){?>style="margin-top:2px;"<?php } ?>>
									...
									Category: <input class="form-control" style="width:40px; display: inline;" type="text" name="item_category[]" value="<?php echo $data['cat'];?>" required /> 
									Index: <input class="form-control" style="width:40px; display: inline;" type="text" name="item_index[]" value="<?php echo $data['id'];?>" required /> 
						...
						<div class="form-actions">
							<button type="submit" class="btn btn-primary" name="edit_achievements" id="edit_achievements">Submt</button>
						</div>
					</form>
					<?php } ?>
				</div>
