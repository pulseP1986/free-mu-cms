...
?>
    <div id="content" class="span10">
        <div>
            <ul class="breadcrumb">
                <li><a href="<?php echo $this->config->base_url; ?>muun-market/admin">Muun Market Settings</a> 
				<span class="divider">/</span></li>
				<li><a href="<?php echo $this->config->base_url; ?>muun-market/logs">Muun Market Logs</a>
                </li>
            </ul>
        </div>
        <?php
                        ...
                        if(isset($logs) && !empty($logs)):
							...
							<script>
								$(document).ready(function () {
									$('span[id^="mlog_item_"]').each(function () {
                            ...
                            <table class="table">
                                ...
                                <?php
                                    foreach($logs as $key => $value){
										...
										<td><span id="mlog_item_' . $key . '" data-info="' . $value['item'] . '">' . $value['name'] . '</span></td>
