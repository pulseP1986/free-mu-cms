			...
			<div class="entry" >
				...
				<div class="form" id="sell_muun_form" style="display:none;width: 100%;">
					<form method="post" action="">
						...
						<tr>
							<td></td>
							<td><button id="sell_muun" name="sell_muun" class="button-style" data-action="<?php echo $this->config->base_url . $this->request->get_controller(); ?>/do-sell-muun"><?php echo __('Sell Muun');?></button></td>
						</tr>
						</table>
					</form>
				</div>
				...
				<?php } else { ?>
				<div class="e_note">Muun inventory not found</div>
				<?php } ?>
				</div>
				</div>
