		...
		<div class="dmn-page-content">
			<div class="row">
				<div class="col-12">   
					...
					?>	
					<h2 class="title"><?php echo __($about['user_description']); ?> <span class="float-right"><a class="btn btn-primary" href="<?php echo $this->config->base_url;?>vip-rewards"><?php echo __($about['name']); ?></a></span></h2>
					<div class="mb-5">
						<?php
						if(isset($error)){
