...
<div id="content" class="span10">
    ...
    <?php if(isset($js)): ?>
        ...
        <script type="text/javascript">
            var vipRewards = new vipRewards();
            vipRewards.setUrl('<?php echo $this->config->base_url . $this->request->get_controller();?>');
            $(document).ready(function () {
                $('form[id^="vip_rewards_settings_form_"]').on("submit", function (e) {
                    e.preventDefault();
                    vipRewards.saveSettings($(this));
                });
            });
        </script>
    <?php endif; ?>
                    ...
                    foreach($server_list AS $key => $data):
                        ...
                        <div role="tabpanel" class="tab-pane fade in <?php if($i == 1){ ?>active<?php } ?>"
                            ...
                            <div class="box-content">
                                <form class="form-horizontal" method="POST" action="" id="vip_rewards_settings_form__<?php echo $key; ?>">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <p class="help-block">Use vip rewards module.</p>
                                        </div>
                                    </div>
									<div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select id="vip_type" name="vip_type" required>
                                                <option value="1" <?php if($val['vip_type'] == 1){
                                                    echo 'selected="selected"';
                                                } ?>>Website based
                                                </option>
                                                <option value="2" <?php if($val['vip_type'] == 2){
                                                    echo 'selected="selected"';
                                                } ?>>IGCN Based
                                                </option>
                                            </select>
                                            <p class="help-block">Vip system type.</p>
                                        </div>
                                    </div>
                                    <div class="form-actions">
                                        <button type="submit" class="btn btn-primary" name="edit_vip_rewards_settings" id="edit_vip_rewards_settings">Save changes</button>
                                    </div>
                                </form>
                            </div>
                        </div>
