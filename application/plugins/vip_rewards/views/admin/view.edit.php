        ...
        <div class="box span12">
            <div class="tab-content">          
				<div class="box-header well">
					<h2><i class="icon-edit"></i>Edit <?php echo $this->Mvip_rewards->get_vip_package_title($achData['vip_type'], $config['vip_type']);?> <?php echo $this->Mvip_rewards->typeToReadable($achData['reward_type']);?> Reward</h2>
				</div>
				<div class="box-content">
						<form class="form-horizontal" method="POST" action="" id="add_reward">
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span3 typeahead" id="min_vip_days" name="min_vip_days" value="<?php if(isset($achData['min_vip_days'])){ echo $achData['min_vip_days']; } else { echo 1; }  ?>" required />
