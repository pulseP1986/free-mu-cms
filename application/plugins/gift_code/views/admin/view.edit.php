            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active">
                    <div class="box-header well">
                        <h2><i class="icon-edit"></i> Edit Coupon</h2>
                    </div>
                    <div class="box-content">
						...
						?>
                        <form class="form-horizontal" method="POST" action="" id="gift_code_generate">
							<div class="control-group">
								<label class="control-label" for="coupon">Coupon </label>
								<div class="controls">
									<input type="text" class="span6 typeahead" id="coupon" name="coupon" value="<?php if(isset($code_info['code'])){ echo $code_info['code']; } ?>" style="text-transform:uppercase" disabled />
								</div>
							</div>
							<div class="control-group">
											...
											foreach($server_list AS $key => $server){
												if($server['visible'] == 1){
													...
													if(substr_count($code_info['server'], ',') > 0){
														...
														$selected = ($code_info['server'] == $key) ? 'selected="selected"' : '';
													}
													echo '<option value="' . $key . '" ' . $selected . '>' . $server['title'] . '</option>' . "\n";
												}
											}
										?>
									</select>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6 datetimepicker" id="valid_until" name="valid_until" value="<?php if(isset($code_info['expires'])){ echo date('Y/m/d H:i', $code_info['expires']); } ?>" required />
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6" id="max_uses" name="max_uses" value="<?php if(isset($code_info['max_uses_total'])){ echo $code_info['max_uses_total']; } ?>" placeholder="999999" required />
									<p class="help-block">How many times coupon can be used in total.</p>
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="uses_left">Uses Left </label>

								<div class="controls">
									<input type="text" class="span6" id="uses_left" name="uses_left" value="<?php if(isset($code_info['uses_left'])){ echo $code_info['uses_left']; } ?>" placeholder="999999" required />
									<p class="help-block">Total uses left.</p>
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6" id="max_uses_by_user" name="max_uses_by_user" value="<?php if(isset($code_info['max_uses_by_user'])){ echo $code_info['max_uses_by_user']; } ?>" placeholder="1" />
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6" id="max_uses_by_char" name="max_uses_by_char" value="<?php if(isset($code_info['max_uses_by_char'])){ echo $code_info['max_uses_by_char']; } ?>" placeholder="1" />
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6" id="min_lvl" name="min_lvl" value="<?php if(isset($code_info['min_lvl'])){ echo $code_info['min_lvl']; } ?>" placeholder="1" />
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6" id="min_mlvl" name="min_mlvl" value="<?php if(isset($code_info['min_mlvl'])){ echo $code_info['min_mlvl']; } ?>" placeholder="1" />
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6" id="min_res" name="min_res" value="<?php if(isset($code_info['min_res'])){ echo $code_info['min_res']; } ?>" placeholder="0" />
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="span6" id="min_gres" name="min_gres" value="<?php if(isset($code_info['min_gres'])){ echo $code_info['min_gres']; } ?>" placeholder="0" />
							...
							<div class="control-group">
								...
								<div class="controls">
									<?php
										$class = [];
										if(isset($code_info['char_class']) && ($code_info['char_class'] != '' and $code_info['char_class'] != null)){
											$class = json_decode($code_info['char_class'], true);
										}
									?>
							...
							<div class="control-group">
								...
								<div class="controls">
									<select id="coupon_type" name="coupon_type" required>
										<option value="0" <?php if(isset($code_info['code_type']) && $code_info['code_type'] == 0){ echo 'selected="selected"'; } ?>>Select</option>
										<option value="1" <?php if(isset($code_info['code_type']) && $code_info['code_type'] == 1){ echo 'selected="selected"'; } ?>>Credits 1</option>
										<option value="2" <?php if(isset($code_info['code_type']) && $code_info['code_type'] == 2){ echo 'selected="selected"'; } ?>>Credits 2</option>
										<option value="3" <?php if(isset($code_info['code_type']) && $code_info['code_type'] == 3){ echo 'selected="selected"'; } ?>>Zen in Web Wallet</option>
										<option value="4" <?php if(isset($code_info['code_type']) && $code_info['code_type'] == 4){ echo 'selected="selected"'; } ?>>Zen in Character</option>
										<option value="5" <?php if(isset($code_info['code_type']) && $code_info['code_type'] == 5){ echo 'selected="selected"'; } ?>>Ruud in Character</option>
										<option value="6" <?php if(isset($code_info['code_type']) && $code_info['code_type'] == 6){ echo 'selected="selected"'; } ?>>WCoin</option>
										<option value="7" <?php if(isset($code_info['code_type']) && $code_info['code_type'] == 7){ echo 'selected="selected"'; } ?>>GoblinPoint</option>
										<option value="8" <?php if(isset($code_info['code_type']) && $code_info['code_type'] == 8){ echo 'selected="selected"'; } ?>>Vip Package</option>
										<option value="9" <?php if(isset($code_info['code_type']) && $code_info['code_type'] == 9){ echo 'selected="selected"'; } ?>>Item</option>
										<option value="10" <?php if(isset($code_info['code_type']) && $code_info['code_type'] == 10){ echo 'selected="selected"'; } ?>>Item hex</option>
										<option value="11" <?php if(isset($code_info['code_type']) && $code_info['code_type'] == 11){ echo 'selected="selected"'; } ?>>Buff Item</option>
							...
							<div class="control-group" id="coin_amount" style="display:none;">
								...
								<div class="controls">
									<input type="text" class="span6" id="reward_amount" name="reward_amount" value="<?php if(isset($code_info['code_reward_currency'])){ echo $code_info['code_reward_currency']; } ?>" />				
								</div>
							</div>
							<div class="control-group" id="vip_package" style="display:none;">
								...
								<div class="controls">
									...
									<select id="vip_type" name="vip_type" required>
										...
										<option value="<?php echo $package['id'];?>" <?php if(isset($code_info['code_reward_vip']) && $code_info['code_reward_vip'] == $package['id']){ echo 'selected="selected"'; } ?>><?php echo $package['package_title'];?></option>
										<?php } ?>
									</select>
									<?php } else { ?>
							...
							<div class="control-group" id="buff_item" style="display:none;">
								...
								<div class="controls" id="bufflist">
									<?php 
									$achData['buffs'] = json_decode($code_info['code_reward_items'], true);
									if(!empty($achData['buffs']) && $code_info['code_type'] == 11){ 
										$i = 0;
							...
							<div class="control-group" id="single_item" style="display:none;">
								...
								<div class="controls" id="itemlist">
									<?php 
									$achData['items'] = json_decode($code_info['code_reward_items'], true);
									if(!empty($achData['items']) && !isset($achData['items'][0]['hex'])  && $code_info['code_type'] == 9){ 
										$i = 0;
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-primary" name="edit_code" id="edit_code">Generate</button>
                            </div>
                        </form>
						<script>
						$(document).ready(function() {
