			...
			<div class="dmn-page-content">
				<div class="row">
					<div class="col-12">     
						...
						<div class="mb-4"></div>
						<link rel="stylesheet" type="text/css" href="<?php echo $this->config->base_url; ?>assets/plugins/css/workshop.css?v2">
						<?php if(isset($js)): ?>
						...
						<?php 
							if(isset($char_list) && !empty($char_list)):
                         ...
                         ?>
                                ...
                                <div id="upgrade-<?php echo $ch['id']; ?>" style="display: none;">
                                    <div class="itemupgrade">
                                        <div class="inventory" style="width: 304px;">
                                            <div class="upgtitle"><?php echo __('Inventory');?></div>
                            ...
                            ?>
							<div class="alert alert-primary"><?php echo __('No Characters Found.'); ?></div>
                            <?php
                            endif;
                            ?>
					</div>	
