    ...
    <?php if(isset($js)): ?>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                $('form[id^="wcoins_exchange_settings_form_"]').on("submit", function (e) {
                    e.preventDefault();
                    wcoinsExchange.saveSettings($(this));
                });
            });
        </script>
    <?php endif; ?>
                        ...
                        <div role="tabpanel" class="tab-pane fade in <?php if($i == 1){ ?>active<?php } ?>"
                            ...
                            <div class="box-content">
                                <form class="form-horizontal" method="POST" action=""
                                      id="wcoins_exchange_settings_form_<?php echo $key; ?>">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="max_wcoins">Max Wcoins </label>

                                        <div class="controls">
                                            <input type="text" class="span3 typeahead" id="max_wcoins" name="max_wcoins"
                                                   value="<?php echo $val['max_wcoins']; ?>" required/>

                                            <p class="help-block">Max wcoins in one exchange.</p>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <p class="help-block">
                                                Exchange ratio. Wcoins/Goblin Points
                                            </p>
                                        </div>
                                    </div>
                                    <div class="form-actions">
                                        <button type="submit" class="btn btn-primary" name="edit_wcoins_exchange_settings"
                                                id="edit_wcoins_exchange_settings">Save changes
                                        </button>
                                    </div>
                                </form>
                            </div>
