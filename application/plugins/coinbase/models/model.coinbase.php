<?php
    ...
    class Mcoinbase extends model
    {
        ...
        /**
         * Check if coinbase package exists
         *
         * @param int $id
         *
         *
        ...
        /**
         * Edit existing coinbase package
         *
         * @param int $id
         * @param string $title
         * @param float $price
        ...
        /**
         * Enable / Disabled coinbase package
         *
         * @param int $id
         * @param int $status
         *
        ...
        /**
         * Load coinbase transactions for logs
         *
         * @param int $page
         * @param int $per_page
         * @param string $acc
        ...
        /**
         * Count total coinbase transactions for pagination
         *
         * @param string $acc
         * @param string $server
         *
        ...
        public function count_total_transactions($acc = '', $server = 'All')
        {
            ...
            $count = $this->website->db('web')->snumrows('SELECT COUNT(acc) AS count FROM DmN_Donate_CoinBase_Transactions ' . $sql . '');
            return $count;
        }

        /**
         * Insert coinbase order
         *
         * @param float $price
         * @param int $currency
         * @param int $reward
        ...
        /**
         * Check if coinbase order exists
         *
         * @param string $item
         *
         *
        ...
        {
            $count = $this->website->db('web')->snumrows('SELECT COUNT(id) AS count FROM DmN_Donate_CoinBase_Orders where hash = \'' . $this->website->db('web')->sanitize_var($item) . '\'');
            if($count == 1){
                $this->order_details = $this->website->db('web')->query('SELECT amount, currency, account, server, credits FROM DmN_Donate_CoinBase_Orders where hash = \'' . $this->website->db('web')->sanitize_var($item) . '\'')->fetch();
                return true;
            } else{
                return false;
            }
        ...
        /**
         * Check if coinbase transaction already processed
         *
         * @param string $item
         *
         *
        ...
        {
            $count = $this->website->db('web')->snumrows('SELECT COUNT(id) AS count FROM DmN_Donate_CoinBase_Transactions where order_hash = \'' . $this->website->db('web')->sanitize_var($item) . '\'');
            if($count > 0){
                return true;
            }
            return false;
