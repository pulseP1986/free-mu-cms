                            ...
                            <div class="entry">
                                ...
                                <script type="text/javascript">
                                    ...
                                    $(document).ready(function () {
                                        $('button[id^="buy_coinbase_"]').on('click', function () {
                                            CoinBase.checkout($(this).attr('id').split('_')[2]);
                                        });
                                    });
                                </script>
                                <?php
                                    if(isset($error)){
                                        ...
                                        if(!empty($packages_coinbase)){
                                            foreach($packages_coinbase as $packages){
										...
										<li>
											...
											<button class="right custom_button" id="buy_coinbase_' . $packages['id'] . '" style="margin-top: 8px;" value="buy_coinbase_' . $packages['id'] . '">' . __('Buy Now') . '</button>
										</li>
								</ul>';
                                            }
                                        } else{
                                            echo '<div class="i_note">' . __('No CoinBase Packages Found.') . '</div>';
                                        }
                                    }
                                ?>
                            </div>
