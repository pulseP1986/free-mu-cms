...
<div id="content" class="span10">
        ...
        <div class="span12">
            <ul class="nav nav-pills">
                ...
                <li role="presentation"><a href="#packages" aria-controls="packages" role="tab" data-toggle="tab">Package
                        Manager</a></li>
                <li><a href="<?php echo $this->config->base_url; ?>coinbase/logs" role="tab">Logs</a></li>
            </ul>
    ...
    <?php if(isset($js)): ?>
        ...
        <script type="text/javascript">
            ...
            CoinBase.setUrl('<?php echo $this->config->base_url . $this->request->get_controller();?>');
            $(document).ready(function () {
                $('form[id^="coinbase_settings_form_"]').on("submit", function (e) {
                    e.preventDefault();
                    CoinBase.saveSettings($(this));
                });
                $("#donate_sortable_coinbase").find("tbody#donate_sortable_content").sortable({
        ...
        <div class="box span12">
            <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade in <?php if($i == 1){ ?>active<?php } ?>"
                            ...
                            <div class="box-content">
                                <form class="form-horizontal" method="POST" action=""
                                      id="coinbase_settings_form_<?php echo $key; ?>">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <p class="help-block">Use Coinbase module.</p>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="app_key">Api Key </label>
                                        <div class="controls">
                                            <input type="text" class="span6 typeahead" id="app_key"
                                                   name="app_key" value="<?php echo $val['app_key']; ?>"/>
                                            <p class="help-block">Your api key in Coinbase payment system.</p>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="shared_secret">Merchant Id </label>
                                        <div class="controls">
                                            <input type="text" class="span6 typeahead" id="shared_secret" name="shared_secret"
                                                   value="<?php echo $val['shared_secret']; ?>"/>
                                            <p class="help-block">Your shared secret in CoinBase payment system.</p>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                    ...
                                    <div class="form-actions">
                                        <button type="submit" class="btn btn-primary" name="edit_coinbase_settings"
                                                id="edit_coinbase_settings">Save changes
                                        </button>
                                    </div>
                                </form>
                            </div>
                ...
                <div role="tabpanel" class="tab-pane fade in" id="packages">
                    <div class="box-header well">
                        <h2><i class="icon-edit"></i> CoinBase Packages</h2>
                    </div>
                    <div class="box-content">
                        <div id="donate_package_list">
                            <table class="table table-striped table-bordered bootstrap-datatable datatable"
                                   id="donate_sortable_coinbase">
                                <thead>
                                <tr>
                                    <th>Title</th>
                                    <th>Price</th>
                                ...
                                <?php foreach($packages_coinbase as $pack): ?>
                                        ...
                                        <td class="center">
                                            <?php if($pack['status'] == 1): ?>
                                                <a class="btn btn-danger" href="#"
                                                   ...
                                                   onclick="CoinBase.changeStatus(<?php echo $pack['id']; ?>, 0);">
                                                    <i class="icon-edit icon-white"></i> Disable
                                                </a>
                                            <?php else: ?>
                                                <a class="btn btn-success" href="#"
                                                   id="status_button_<?php echo $pack['id']; ?>"
                                                   onclick="CoinBase.changeStatus(<?php echo $pack['id']; ?>, 1);">
                                                    <i class="icon-edit icon-white"></i> Enable
                                                </a>
                                            <?php endif; ?>
                                            <a class="btn btn-info" href="#"
                                               onclick="CoinBase.edit(<?php echo $pack['id']; ?>);">
                                                <i class="icon-edit icon-white"></i> Edit
                                            </a>
                                            <a class="btn btn-danger" href="#"
                                               onclick="CoinBase.delete(<?php echo $pack['id']; ?>);">
                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-success" href="#" onclick="CoinBase.addPackage();">
