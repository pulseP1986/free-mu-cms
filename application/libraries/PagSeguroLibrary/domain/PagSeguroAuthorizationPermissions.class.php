<?php
    ...
    class PagSeguroAuthorizationPermissions
    {
         ...
         */
        private $permissionList = ["CREATE_CHECKOUTS", "RECEIVE_TRANSACTION_NOTIFICATIONS", "SEARCH_TRANSACTIONS", "MANAGE_PAYMENT_PRE_APPROVALS", "DIRECT_PAYMENT", "REFUND_TRANSACTIONS", "CANCEL_TRANSACTIONS"];
        /*
         * @var $permissions
         */
        private $permissions;
